...
var s = (function () {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Home";
    			attr_dev(h1, "class", "svelte-15owf82");
    			add_location(h1, file$1, 6, 0, 70);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src/components/Face.svelte generated by Svelte v3.28.0 */
    const file$2 = "src/components/Face.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "eye svelte-vtvn9p");
    			add_location(div0, file$2, 83, 4, 2425);
    			attr_dev(div1, "id", "right");
    			attr_dev(div1, "class", "eye svelte-vtvn9p");
    			add_location(div1, file$2, 84, 4, 2459);
    			attr_dev(div2, "class", "eye-row svelte-vtvn9p");
    			add_location(div2, file$2, 82, 2, 2399);
    			attr_dev(div3, "class", "mouth svelte-vtvn9p");
    			add_location(div3, file$2, 87, 4, 2529);
    			attr_dev(div4, "class", "mouth-row svelte-vtvn9p");
    			add_location(div4, file$2, 86, 2, 2501);
    			attr_dev(div5, "class", "face svelte-vtvn9p");
    			add_location(div5, file$2, 81, 0, 2361);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	onMount(() => {
    		$$invalidate(0, face.speak = speak, face);

    		face.addEventListener("click", () => {
    			msg.update(msg => msg === "Hello World!"
    			? "Goodbye Moon!"
    			: "Hello World!");
    			...
    			face.speak(`Hello! What is your name?`).then(() => {
    				...
    				speechRecognition.onresult = ({ results }) => {
    					...
    					const userName = transcript.replace(/hello|hi|my|name|is/g, "");
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<Face> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$capture_state = () => ({ msg, onMount, face, speak });
    ...
    /* src/routes/Bot.svelte generated by Svelte v3.28.0 */
    ...
    function create_default_slot(ctx) {
    	...
    	const block = {
    		c: function create() {
    			nav = element("nav");
    			t0 = text(/*msgStore*/ ctx[0]);
    			t1 = space();
    			create_component(link0.$$.fragment);
    			t2 = space();
    			create_component(link1.$$.fragment);
    			t3 = space();
    			t4 = text(/*msgStore*/ ctx[0]);
    			t5 = space();
    			div = element("div");
    			create_component(route0.$$.fragment);
    			t6 = space();
    			create_component(route1.$$.fragment);
    			attr_dev(nav, "class", "svelte-1kx2ws0");
    			add_location(nav, file$3, 29, 4, 726);
    			add_location(div, file$3, 35, 4, 844);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (!current || dirty & /*msgStore*/ 1) set_data_dev(t0, /*msgStore*/ ctx[0]);
    			const link0_changes = {};
    			...
    			if (!current || dirty & /*msgStore*/ 1) set_data_dev(t4, /*msgStore*/ ctx[0]);
    		},
    		i: function intro(local) {
    			if (current) return;
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "background svelte-1kx2ws0");
    			add_location(div0, file$3, 27, 2, 684);
    			attr_dev(div1, "id", "app");
    			attr_dev(div1, "class", "svelte-1kx2ws0");
    			add_location(div1, file$3, 26, 0, 667);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$6($$self, $$props, $$invalidate) {
    	...
    	let msgStore;
    	const unsubMsgStore = msg.subscribe(val => $$invalidate(0, msgStore = val));
    	const writable_props = [];
    	...
    	$$self.$inject_state = $$props => {
    		if ("msgStore" in $$props) $$invalidate(0, msgStore = $$props.msgStore);
    	};
